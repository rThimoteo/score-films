<div class="text-white flex justify-center self-center">
    <form wire:submit="save" class="w-full flex flex-col justify-end">
        <div class="flex flex-row w-full gap-4">
            <div class="flex flex-col basis-1/2 w-0 px-8 py-6 gap-8">
                <div>
                ...
                <div>
                    ...
                    <select id="type_id" required wire:model.live="type_id"
                        class="text-sm rounded-lg block w-full p-2.5 bg-gray-700 border-gray-600 placeholder-gray-400 text-white focus:ring-blue-500 focus:border-blue-500">
                ...
                <div class="flex items-center gap-2 w-fit">
                    <input id="has_parent" type="checkbox" wire:model.live="hasParent"
                ...
                @if ($hasParent)
                    <div id='search' class="" x-data="{ open: false }" @click.away="open = false">
            ...
            <div class="flex flex-col basis-1/2 w-0 px-8 py-6 gap-8">
                <div class="flex flex-col">
                    ...
                    <div class="flex gap-2 items-center justify-between">
                        <div class="bg-gray-700 flex rounded-lg px-2 text-sm items-center h-10 w-full max-w-[80%]">
                            <p class="truncate">
